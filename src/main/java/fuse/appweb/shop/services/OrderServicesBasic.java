...
public class OrderServicesBasic implements OrderServices {
    ...
    static {
        ...
        productsMap.put("Omega Men's Seamaster 300M Chronometer", new Product("Omega Men's Seamaster 300M Chronometer", 8870000,"Watch", "Precise automatic swiss Movement, Sapphire crystal; Brushed and polished stainless steel case and bracelet.",10,"images/Omega.jpg"));
        productsMap.put("Beats By Dre Solo 2 Luxe Edition", new Product("Beats By Dre Solo 2 Luxe Edition", 380000, "Headphone", "On-Ear Headphones | Black (WIRED, Not Wireless), Custom-fit feeling with curved frame, Ergonomic earcups, Refined glossy finish.",10,"images/Beats.jpg"));
        productsMap.put("Gibson Les Paul Custom Electric Guitar", new Product("Gibson Les Paul Custom Electric Guitar", 6500300,"Music", "The body of the Les Paul Signature has the modern weight relieved Mahogany body with 3 ply W/B/W binding and a AA figured Maple top. It also has a Mahogany neck with a 50's Round Profile",10,"images/Gibson.jpg"));
        productsMap.put("Alienware 17 ANW17-2136SLV 17 Inch Laptop", new Product("Alienware 17 ANW17-2136SLV 17 Inch Laptop", 6100000, "Laptop", "Intel Core i7-4710HQ Processor (Quad-Core, 6MB Cache, up to 3.5GHz w/ Turbo Boost), 8 GB DDR3 RAM, 1000 GB 5400 rpm Hard Drive, 17.3-Inch Screen, NVIDIA GeForce GTX 970M with 3GB GDDR5",10,"images/Alienware17.jpg"));
        productsMap.put("Samsung Chromebook Plus Convertible Touch Laptop (XE513C24-K01US)", new Product("Samsung Chromebook Plus Convertible Touch Laptop (XE513C24-K01US)", 1600000, "Laptop","Flexible 360° profile. Enables you to use upright as a computer to reply to emails or finish a paper and recline for a tablet view ideal for surfing and viewing,This Device comes with the pen out of the box. Power to personalize your communications by writing directly on screen. Take notes, make a sketch, capture part of the screen, etc, Speed (GHz):2Ghz.",10,"images/SamsungChromebook.jpg"));
        productsMap.put("Dell Inspiron 13 7000 Series 13.3-Inch Convertible", new Product("Dell Inspiron 13 7000 Series 13.3-Inch Convertible", 2999000, "Laptop","Intel Core i5-5200U Processor (3M Cache, 2.2 GHz), 8 GB DDR3, 13.3 in Full HD IPS LED touchscreen (1920 x 1080), 10-finger multi-touch support",10,"images/DellInspiron13.jpg"));
